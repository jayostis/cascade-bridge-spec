...
def test_an_address_selecting_no_node_of_the_input_is_compared_as_it_is_written():
    assert "one selecting no node matches only the same spelling" in HOW_AN_ISOMORPHIC_CONVERSION_TEST_COMPARES
